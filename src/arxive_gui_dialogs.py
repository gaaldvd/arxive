...
from ui.LogViewer import Ui_Dialog as LogViewerDlg
...
class ConfigDialog(ConfigDlg, QDialog):
    ...
    `src/ui/Config.py <https://github.com/gaaldvd/arxive/blob/main/src/ui/Config.py>`_
    in the repository.
    ...
    def __init__(self, config, parent=None):
        ...
        :param Config config: The configurations stored in
            :ref:`config_path <config-class>`.
        :param MainWindow parent: The parent window.
        """
...
class AboutDialog(AboutDlg, QDialog):
    ...
    pyside6-uic from the QtDesigner .ui file and can be found in
    `src/ui/About.py <https://github.com/gaaldvd/arxive/blob/main/src/ui/About.py>`_
    in the repository.
...
class LogViewerDialog(LogViewerDlg, QDialog):
    """Handles the session log viewer of the application.

    The class inherits from `Pyside6.QtWidgets.QDialog`
    and `src.ui.LogViewer.Ui_Dialog`.

    The GUI was made with QtDesigner. `LogViewer.Ui_Dialog` is generated by
    pyside6-uic from the QtDesigner .ui file and can be found in
    `src/ui/LogViewer.py <https://github.com/gaaldvd/arxive/blob/main/src/ui/LogViewer.py>`_
    in the repository.
    """
    ...
    def __init__(self, log_path, parent=None):
        ...
        :param str log_path: The :ref:`path <session-class>` to the session log.
        :param MainWindow parent: The parent window.
        """
        ...
        with open(log_path, 'r', encoding="utf-8") as log:
            for line in log:
                self.sessionLog.appendPlainText(line.strip())